...
export CIBW_ENVIRONMENT="${CIBW_ENVIRONMENT:-MLC_Z3_STATIC_PLAT_NAME='${MLC_Z3_STATIC_PLAT_NAME}' MACOSX_DEPLOYMENT_TARGET='${MACOSX_DEPLOYMENT_TARGET}' CMAKE_BUILD_PARALLEL_LEVEL='${CMAKE_BUILD_PARALLEL_LEVEL}'}"
