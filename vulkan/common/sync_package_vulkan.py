...
def name_with_vulkan(args, package_name):
    """Update name with vulkan"""
    return package_name + "-vulkan"
...
def update_setup(args, package_name):
    ...
    rewrites = [
        (r'(?<=name=")[^\"]+', name_with_vulkan(args, package_name)),
...
def main():
    ...
    parser.add_argument("build_type",
                        type=str,
                        help="Type of package to be built. Use 'mlc-ai' to build the last stable "
                             "revision or 'mlc-ai-nightly' build the value provided via --revision.")
